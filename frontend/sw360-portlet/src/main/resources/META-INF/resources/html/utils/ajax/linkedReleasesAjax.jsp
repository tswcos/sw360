...
<core_rt:forEach items="${releaseList}" var="releaseLink" varStatus="loop">
    ...
    <tr id="releaseLinkRow${uuid}" >
        ...
        <td class="content-middle">
            <svg title="<liferay-ui:message key="delete" />" class="action lexicon-icon" data-row-id="releaseLinkRow${uuid}" data-release-name="<sw360:out value='${releaseLink.longName}' jsQuoting="true"/>">
